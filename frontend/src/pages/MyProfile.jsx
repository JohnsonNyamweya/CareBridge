...
const MyProfile = () => {
  const {userData, setUserData, backendUrl, userToken, loadUserProfileData} = useContext(AppContext);
    ...
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      {
        ...
        ? <label htmlFor="image">
            <div className="inline-block relative cursor-pointer">
              ...
              <img className="w-10 absolute bottom-12 right-12 bg-gray-400" src={image ? '' : assets.upload_icon} alt="" />
            </div>
